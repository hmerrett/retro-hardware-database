...
PORT_CODES = [("I", "IDE"), ("C", "SCSI"), ("A", "SATA"), ("F", "Floppy"),
              ("S", "Serial"), ("P", "Parallel"), ("G", "Game")]
...
def ask_ports(specs):
    raw = ask("ports — letters I=IDE C=SCSI A=SATA F=Floppy S=Serial P=Parallel "
              "G=Game (e.g. IFSSP), blank to skip")
    if not raw:
        return specs
